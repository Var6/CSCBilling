      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
          <div className="lg:col-span-4">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-[26px] font-bold text-[#1A2332] tracking-tight">csctravels</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-10 border-y border-[#E5E7EB] mb-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[#1A2332] font-semibold">ops@csctravels.com</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-[#DBEAFE] rounded-full flex items-center justify-center text-[#2563EB]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[#9CA3AF] text-sm">
            &copy; 2026 csctravels Technologies. All rights reserved. Built for the future of logistics.
          </p>
